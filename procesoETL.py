...
if __name__ == "__main__":
    ...
    masPopulares.to_sql('masPopulares', con=engine, index=False)
    masPopulares_results.to_sql('masPopulares_results', con=engine, index=False)
    publicado.to_sql('publicado', con=engine, index=False)
    publicado_results.to_sql('publicado_results', con=engine, index=False)
    publicado_results_lists.to_sql('publicado_results_lists', con=engine, index=False)
    publicado_results_lists_books.to_sql('publicado_results_lists_books', con=engine, index=False)